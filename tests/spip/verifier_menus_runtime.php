...
$menus = array('adherents', 'cotisations', 'activites', 'benevoles', 'partenaires', 'commerce', 'ventes', 'dons', 'comptes', 'transactions', 'prets', 'bannieres', 'notifications', 'configurer_association');
