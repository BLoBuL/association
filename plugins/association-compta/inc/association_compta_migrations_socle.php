...
function association_compta_association_migrations_historiques($flux) {
	...
	$versions = array('1.1.0','1.1.7','1.1.8','1.1.9','1.1.10','1.2.4','1.4.7','1.5.5','1.5.7');
	$etapes = array();
	foreach ($versions as $version) {
		$etapes[] = array($version, array('association_compta_migration_legacy', $version), $version === '1.1.0' ? 40 : 20);
	}
