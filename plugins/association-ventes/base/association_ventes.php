...
function association_ventes_declarer_tables_objets_sql($tables) {
	$tables['spip_asso_ventes'] = [
		'field' => [
			...
			'code' => 'TEXT NOT NULL',
			'id_produit' => 'BIGINT DEFAULT NULL',
			'id_commande' => 'BIGINT DEFAULT NULL',
			'id_commandes_detail' => 'BIGINT DEFAULT NULL',
			'origine' => "VARCHAR(30) NOT NULL DEFAULT 'manuelle'",
			...
			'prix_vente' => 'TINYTEXT',
			'prix_unitaire_ht' => 'DECIMAL(20,6) DEFAULT NULL',
			'taxe' => 'DECIMAL(6,5) DEFAULT NULL',
			'reduction' => 'DECIMAL(6,5) DEFAULT NULL',
		...
		'key' => [
			...
			'UNIQUE KEY commande_detail' => 'id_commande,id_commandes_detail',
		],
		'principale' => 'oui',
		'titre' => 'article AS titre, "" AS lang',
	];
	return $tables;
}
