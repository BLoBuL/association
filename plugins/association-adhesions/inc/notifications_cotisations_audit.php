...
function notifications_cotisations_audit_catalogue() {
    return array(
        ...
        array('id' => 'recu', 'label' => 'Recu d\'encaissement', 'template' => 'notifications/recu_encaissement_adhesion', 'sujet_cle' => 'association_adhesions:email_recu_encaissement_adhesion_sujet', 'audience' => 'Adherent (+ BCC configure)', 'declencheur' => 'Encaissement payant uniquement', 'file' => true, 'option' => 'meta_cfg_envoi_recu_paiement_adhesion'),
