...
function facteur_envoyer_notification_gis($id_auteur,$nom_auteur,$string_recherche,$nouvelle_adresse,$id_gis,$action) {
    ...
    $destinataire_meta = isset($GLOBALS['association_metas']['notification_gis_config_email']) ? $GLOBALS['association_metas']['notification_gis_config_email'] : '';
    ...
    $envoyer = facteur_envoyer_app($dest, $sujet, $corps, false, array('enqueued' => true, 'use_queue' => false));
