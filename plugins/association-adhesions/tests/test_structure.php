...
foreach (['prefix="association_adhesions"', 'compatibilite="[4.0.0;4.*]"', 'schema="1.1.0"', 'nom="inscription4"'] as $attendu) {
...
foreach (['spip_asso_categories_adherents', 'spip_asso_cotisations'] as $table) {
...
foreach (['type_adherent', 'date_debut_validite', 'date_fin_validite', 'validation', 'document_justificatif', 'nombre_enfants', 'mode_paiement', 'eligibilite'] as $champ) {
...
foreach (['profil.html', 'fiche_adherent.html', 'inscription.html'] as $page) {
