...
function association_evenements_profil_participant(array $participant) {
	...
	$auteur = $id_auteur ? (sql_fetsel('*', 'spip_auteurs', 'id_auteur=' . $id_auteur) ?: []) : [];
...
function formulaires_editer_evenement_charger($id_evenement = 'new', $id_article = 0, $retour = '', $lier_trad = 0, $config_fonc = 'evenements_edit_config', $row = [], $hidden = '') {
...
function formulaires_editer_evenement_verifier($id_evenement = 'new', $id_article = 0, $retour = '', $lier_trad = 0, $config_fonc = 'evenements_edit_config', $row = [], $hidden = '') {
