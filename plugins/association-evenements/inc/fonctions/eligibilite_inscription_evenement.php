...
function eligibilite_inscription_evenement($id_evenement){
    ...
    if(!is_null($id_activite)){
        $eligibilite_inscription_evenement += array('id_activite' => $id_activite);
    }
    if($eligibilite_token_inscription === 'oui'){
        $eligibilite_inscription_evenement += array('eligibilite_token_inscription' => 'oui', 'token_url' => $token_url);
    }
