...
function association_declarer_champs_extras_impl($champs = []) {
...
function association_preparer_donnees_communes() {
	...
	$donnees['mode_paiement_liste'] = $mode_paiement_liste ?? [];
	$donnees['mode_paiement_listes'] = $mode_paiement_listes ?? [];
...
function association_champs_evenement_base($champs, $donnees) {
	// Champs descriptifs
	$champs['spip_evenements']['descriptif'] = [
		'saisie' => 'textarea',
		'source' => 'agenda',
		'options' => [
			'nom' => 'descriptif',
	...
	$champs['spip_evenements']['descriptif_securise'] = [
		'saisie' => 'textarea',
		'source' => 'association',
		'options' => [
	...
	$champs['spip_evenements']['presentiel'] = [
		'saisie' => 'radio',
		'options' => [
			'nom' => 'presentiel',
	...
	$champs['spip_evenements']['adresse'] = [
		'saisie' => 'input',
		'source' => 'adresse',
		'options' => [
			'nom' => 'adresse',
	...
	$champs['spip_evenements']['responsables'] = [
		// -----------------------------------------------
	...
	$champs['spip_evenements']['inscription'] = [
		'saisie' => 'radio',
		'source' => 'agenda',
		'options' => [
			'nom' => 'inscription',
...
function association_champs_inscription($champs, $donnees) {
	...
	$champs['spip_evenements']['fieldset_inscription_en_ligne'] = [
		'saisie' => 'fieldset',
		'options' => [
...
function association_champs_validation($champs) {
	$champs['spip_evenements']['evenement_fieldset'] = [
		'saisie' => 'fieldset',
		'options' => [
			'nom' => 'association',
...
function association_champs_paiement($champs, $donnees_communes) {
	...
	if (function_exists('bank_lister_configs')) {
		...
		$mode_paiement_liste = !empty($mode_paiement_participation) ?
			unserialize($mode_paiement_participation) : [];
	...
	$champs['spip_evenements']['evenement_payant'] = [
		'saisie' => 'fieldset',
		'options' => [
	...
	while ($categorie = sql_fetch($categorie_querie)) {
		$saisie_categorie['categorie_prix_' . $categorie['id_categorie']] = [
			'saisie' => 'input',
			'source' => 'association',
			'options' => [
	...
	$saisie_categorie['mode_paiement'] = [
		'saisie' => 'checkbox',
		'source' => 'association',
		'options' => [
			'nom' => 'mode_paiement',
	...
	$champs['spip_evenements']['categorie_prix'] = [
		'saisie' => 'fieldset',
		'options' => [
			'nom' => 'categorie_prix',
...
function association_champs_accompagnants($champs) {
	$champs['spip_evenements']['accompagnant'] = [
		'saisie' => 'fieldset',
		'options' => [
			'nom' => 'accompagnant',
		...
		'saisies' => [
			...
			'limite_places' => [
				...
				'options' => [
					...
					'datas' => [
						'2' => _T('association_evenements:evenement_nb_participant', ['nb' => 2]),
						'3' => _T('association_evenements:evenement_nb_participant', ['nb' => 3]),
						'4' => _T('association_evenements:evenement_nb_participant', ['nb' => 4]),
						'5' => _T('association_evenements:evenement_nb_participant', ['nb' => 5]),
						'6' => _T('association_evenements:evenement_nb_participant', ['nb' => 6]),
						'7' => _T('association_evenements:evenement_nb_participant', ['nb' => 7]),
						'8' => _T('association_evenements:evenement_nb_participant', ['nb' => 8]),
						'9' => _T('association_evenements:evenement_nb_participant', ['nb' => 9]),
						'10' => _T('association_evenements:evenement_nb_participant', ['nb' => 10]),
					],
				],
			],
...
function association_champs_attente($champs) {
	$champs['spip_evenements']['attente'] = [
		'saisie' => 'fieldset',
		'options' => [
			'nom' => 'attente',
...
function association_champs_conditions_inscription($champs, $donnees_communes) {
	...
	if ($condition_inscription_defaut == 'jamais') {
		...
		$champs['spip_evenements']['condition_inscription'] = [
			'saisie' => 'hidden',
			'options' => [
		...
		$champs['spip_evenements']['message_condition_inscription'] = [
			'saisie' => 'hidden',
			'options' => [
				'sql' => 'TEXT',
		...
		$champs['spip_evenements']['fieldset_modalites'] = [
			'saisie' => 'fieldset',
			'options' => [
...
function association_champs_info_supplementaire($champs) {
	if (isset($champs['spip_evenements']['fieldset_modalites']) &&
	   isset($champs['spip_evenements']['fieldset_modalites']['saisies'])) {
		...
		$champs['spip_evenements']['fieldset_modalites']['saisies']['info_suppelmentaire'] = [
			'saisie' => 'checkbox',
			'source' => 'association',
			'options' => [
...
function association_champs_communication_fiafe($champs) {
	$champs['spip_evenements']['fieldset_communication'] = [
		'saisie' => 'fieldset',
		'options' => [
	...
	$champs['spip_evenements']['reseau_fiafe'] = [
		'saisie' => 'radio',
		'source' => 'association',
		'options' => [
