...
function association_bons_plans_declarer_tables_objets_sql($tables) {
	$tables['spip_bons_plans'] = [
		'type' => 'bon_plan',
		'page' => 'bon_plan',
		'principale' => 'oui',
		'table_objet_surnoms' => ['bonsplan'],
		...
		'champs_editables' => ['titre', 'texte', 'url_site_internet', 'adresse', 'telephone', 'email_contact', 'date_depublication'],
		'champs_versionnes' => ['titre', 'texte', 'url_site_internet', 'adresse', 'telephone', 'email_contact', 'date_depublication'],
		'rechercher_champs' => ['titre' => 8, 'texte' => 5, 'adresse' => 2],
		'tables_jointures' => ['spip_bons_plans_liens'],
		...
		'statut' => [['champ' => 'statut', 'publie' => 'publie', 'previsu' => 'publie,prop,prepa', 'post_date' => 'date', 'exception' => ['statut', 'tout']]],
...
function association_bons_plans_declarer_tables_auxiliaires($tables) {
	$tables['spip_bons_plans_liens'] = [
		'field' => ['id_bon_plan' => 'BIGINT NOT NULL DEFAULT 0', 'id_objet' => 'BIGINT NOT NULL DEFAULT 0', 'objet' => "VARCHAR(25) NOT NULL DEFAULT ''", 'vu' => "VARCHAR(6) NOT NULL DEFAULT 'non'"],
		'key' => ['PRIMARY KEY' => 'id_bon_plan,id_objet,objet', 'KEY id_bon_plan' => 'id_bon_plan', 'KEY objet' => 'objet,id_objet'],
	];
	return $tables;
}
