...
function autoriser_bannieres_menu_dist($faire, $type = '', $id = 0, $qui = null, $opt = null) { return association_est_admin_complet(association_normalize_qui($qui)); }
function autoriser_banniere_creer_dist($faire, $type, $id, $qui, $opt) { return autoriser('bannieres_menu', '', 0, $qui); }
